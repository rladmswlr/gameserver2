...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\user\\OneDrive - 홍익대학교\\바탕 화면\\sparta\\gameserver2\\prisma\\item",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "e0bfd6b79718d034bf6ae93cd512617fc5e83bfe2eaef4b79980798a048999c3",
  "copyEngine": true
}
...
path.join(process.cwd(), "prisma/item/query_engine-windows.dll.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-debian-openssl-3.0.x.so.node");
path.join(process.cwd(), "prisma/item/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/item/schema.prisma")
